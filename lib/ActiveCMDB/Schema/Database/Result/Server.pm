use utf8;
package ActiveCMDB::Schema::Database::Result::Server;
...
ActiveCMDB::Schema::Database::Result::Server
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:G0kNGECilPazam+xtNIf4A
