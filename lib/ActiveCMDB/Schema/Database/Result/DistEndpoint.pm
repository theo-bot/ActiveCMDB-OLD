use utf8;
package ActiveCMDB::Schema::Database::Result::DistEndpoint;
...
ActiveCMDB::Schema::Database::Result::DistEndpoint - Distribution endpoints
...
Related object: L<ActiveCMDB::Schema::Database::Result::DistRule>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2RAZ1rv1coYwpmy/ldhIXg
