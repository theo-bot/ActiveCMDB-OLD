use utf8;
package ActiveCMDB::Schema::Database::Result::Contract;
...
ActiveCMDB::Schema::Database::Result::Contract
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XlphyYcMof32O6U5vlfrcQ
