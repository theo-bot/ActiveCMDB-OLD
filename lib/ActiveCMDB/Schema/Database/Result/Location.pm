use utf8;
package ActiveCMDB::Schema::Database::Result::Location;
...
ActiveCMDB::Schema::Database::Result::Location
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Z30GLQxOc34bMxD0oKQAuA
