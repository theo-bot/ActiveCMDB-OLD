...
"x86_64-linux-thread-multi-2.6.32-279.1.1.el6.centos.plus.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.32-279.1.1.el6.centos.plus.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
